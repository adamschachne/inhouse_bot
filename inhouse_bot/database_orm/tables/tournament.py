...
from sqlalchemy import Column, BigInteger, ForeignKeyConstraint, DateTime, ForeignKey, String
...
class Tournament(bot_declarative_base):
    ...
    game = relationship(
        "game", viewonly=True, backref="game_participant_objects", sync_backref=False
    )
